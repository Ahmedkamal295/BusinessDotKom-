...
class SuggestionProductVC: UIViewController {
...
extension SuggestionProductVC: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! CellSuggestionProduct
...
extension SuggestionProductVC : UICollectionViewDelegateFlowLayout {
