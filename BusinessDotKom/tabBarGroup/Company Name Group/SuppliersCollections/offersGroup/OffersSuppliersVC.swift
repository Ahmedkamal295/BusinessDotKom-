...
class OffersSuppliersVC: UIViewController,UITableViewDataSource,UITableViewDelegate {
    var imgArr = [("watcht"),("Alexandra Daddario"),("Angelina Jolie"),("Anne Hathaway"),("Dakota Johnson"),("Emma Stone"),("Emma Watson"),("Halle Berry"),("Jennifer Lawrence"),("Jessica Alba"),("Scarlett Johansson"),("watcht"),("Adele"),("Angelina Jolie"),("Halle Berry"),]
             ...
             let Price = [("30.000  $"),
                          ...
                          ("80.000  $"),
                          ("20.000  $")]
    var imgArrya = [ UIImage(named:"watch"),
                       UIImage(named:"watch") ,
                       UIImage(named:"watch") ,
                       UIImage(named:"watch") ,
                       UIImage(named:"watch") ,]
      ...
      var nameProduct = [("Store Name"),("Store Name"),("Store Name"),("Store Name"),("Store Name"),("Store Name"),("Store Name")]
    ...
    func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
         ...
         func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
             let cell = tableView.dequeueReusableCell(withIdentifier: "cell", for: indexPath) as? TableCellOffersSuppliers
...
extension OffersSuppliersVC : UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        return 7
    }
    
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as? CollectionCellOffersSuppliers
