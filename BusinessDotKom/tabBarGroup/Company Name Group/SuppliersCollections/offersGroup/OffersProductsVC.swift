...
class OffersProductsVC: UIViewController {
...
extension OffersProductsVC: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
            ...
            let cell = collectionView.dequeueReusableCell(withReuseIdentifier: "cell", for: indexPath) as! CellProducts
...
extension OffersProductsVC : UICollectionViewDelegateFlowLayout {
