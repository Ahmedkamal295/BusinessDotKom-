...
class SignInSupplierVC: UIViewController {
    ...
    @IBAction func btnServices(_ sender: Any) {
            let storyBoard : UIStoryboard = UIStoryboard(name: "Main", bundle:nil)
            let nextViewController = storyBoard.instantiateViewController(withIdentifier: "SignInSupplierServicesVC") as! SignInSupplierServicesVC
